...
const workerSeeds = [
  ...
  {
    fullName: 'Ngozi Nnamani',
    email: 'ngozi.nnamani@athand.test',
    phone: '08030000011',
    profilePhotoUrl: '/images/workers/worker-01.svg',
    occupation: 'House Maid',
    bio: 'Organized domestic assistant for family homes, laundry rotation, room resets, and guest preparation.',
    yearsExperience: 6,
    serviceArea: ['Lekki Phase 1, Lagos', 'Chevron, Lagos'],
    hourlyRate: 7000,
    languages: ['English', 'Igbo'],
    skills: ['Housekeeping', 'Laundry', 'Guest room setup'],
    emergencyServices: false,
    verificationStatus: 'verified',
    averageRating: 4.8,
    totalReviews: 69,
  ...
  {
    fullName: 'Rasheed Lawal',
    email: 'rasheed.lawal@athand.test',
    phone: '08030000012',
    profilePhotoUrl: '/images/workers/worker-02.svg',
    occupation: 'Driver',
    bio: 'Reliable city driver for executive movement, family logistics, and late-evening airport pickups.',
    yearsExperience: 9,
    serviceArea: ['Ikoyi, Lagos', 'Victoria Island, Lagos'],
    hourlyRate: 9500,
    languages: ['English', 'Yoruba'],
    skills: ['Executive driving', 'Airport pickups', 'Route planning'],
    emergencyServices: false,
    verificationStatus: 'verified',
    averageRating: 4.8,
    totalReviews: 73,
  ...
  },
  {
    ...
    email: 'halima.garba@athand.test',
    phone: '08030000013',
    profilePhotoUrl: '/images/workers/worker-03.svg',
    occupation: 'Childcare Specialist',
    bio: 'Warm childcare professional trusted for after-school support, bedtime routines, and infant supervision.',
    yearsExperience: 8,
    serviceArea: ['Wuse 2, Abuja', 'Maitama, Abuja'],
    hourlyRate: 9200,
    languages: ['English', 'Hausa'],
    skills: ['Infant care', 'Homework supervision', 'Meal support'],
    emergencyServices: false,
    verificationStatus: 'verified',
    averageRating: 4.9,
    totalReviews: 82,
  ...
  {
    fullName: 'Tosin Fadeyi',
    email: 'tosin.fadeyi@athand.test',
    phone: '08030000014',
    profilePhotoUrl: '/images/workers/worker-04.svg',
    occupation: 'Painter',
    bio: 'Interior painter for apartments, offices, and touch-up finishing with fast turnaround and clean execution.',
    yearsExperience: 7,
    serviceArea: ['Surulere, Lagos', 'Yaba, Lagos'],
    hourlyRate: 10000,
    languages: ['English', 'Yoruba'],
    skills: ['Interior painting', 'Surface prep', 'Color finishing'],
    emergencyServices: false,
    verificationStatus: 'verified',
    averageRating: 4.7,
    totalReviews: 57,
  ...
  {
    fullName: 'Maryam Sule',
    email: 'maryam.sule@athand.test',
    phone: '08030000015',
    profilePhotoUrl: '/images/workers/worker-05.svg',
    occupation: 'Cook',
    bio: 'Family cook focused on weekly meal prep, event trays, and balanced menu planning for busy homes.',
    yearsExperience: 6,
    serviceArea: ['Garki, Abuja', 'Wuse, Abuja'],
    hourlyRate: 10500,
    languages: ['English', 'Hausa'],
    skills: ['Meal prep', 'Event trays', 'Menu planning'],
    emergencyServices: false,
    verificationStatus: 'verified',
    averageRating: 4.8,
    totalReviews: 61,
    completedBookings: 114,
    totalBookings: 119,
    trustScore: 90,
    serviceSlugs: ['cook'],
  },
  {
    fullName: 'Kayode Bamisile',
    email: 'kayode.bamisile@athand.test',
    phone: '08030000016',
    profilePhotoUrl: '/images/workers/worker-06.svg',
    occupation: 'Electrician',
    bio: 'Residential electrician for inverter issues, breaker trips, rewiring, and urgent fault isolation.',
    yearsExperience: 11,
    serviceArea: ['Ikeja, Lagos', 'Maryland, Lagos'],
    hourlyRate: 12500,
    languages: ['English', 'Yoruba'],
    skills: ['Fault tracing', 'Rewiring', 'Inverter maintenance'],
    emergencyServices: true,
    verificationStatus: 'verified',
    averageRating: 4.9,
    totalReviews: 88,
