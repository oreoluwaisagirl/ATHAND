...
const HelpCenter = () => {
  ...
  const helpTopics = [
    { id: 1, title: 'Getting Started', icon: '🚀', description: 'Learn how to use ATHAND' },
    { id: 2, title: 'Booking Help', icon: '📅', description: 'How to book services' },
    { id: 3, title: 'Payment Issues', icon: '💳', description: 'Payment and billing support' },
    { id: 4, title: 'Account Security', icon: '🔒', description: 'Keep your account safe' },
    { id: 5, title: 'Provider Support', icon: '👷', description: 'Help for service providers' },
    { id: 6, title: 'Report a Problem', icon: '⚠️', description: 'Report issues or concerns' },
  ];
