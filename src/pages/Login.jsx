...
const Login = () => {
  ...
  return (
    <InteriorPage
      ...
      description="Access bookings, saved providers, messages, and account settings from the same marketplace flow, now with standard password sign in."
        ...
        <Card className="rounded-[1.8rem] border border-[#eadfd6] bg-white shadow-[0_18px_40px_rgba(39,55,86,0.08)]">
          <CardContent className="p-6 sm:p-8">
            <div className="mb-8">
              ...
              <p className="mt-3 text-sm leading-7 text-text-secondary">Use your email and password to continue into your dashboard.</p>
            </div>
          ...
          <Card className="rounded-[1.8rem] border border-[#eadfd6] bg-[#faf7f4]">
            <CardContent className="p-6">
              ...
              <p className="mt-3 text-sm leading-7 text-text-secondary">
                Join as a service seeker or request provider access with a standard password-based signup flow.
              </p>
          ...
          <Card className="rounded-[1.8rem] border border-[#eadfd6] bg-white">
            <CardContent className="p-6">
              ...
              <div className="mt-4 space-y-3">
                {['Password sign in', 'Track active bookings', 'Manage your profile settings'].map((item) => (
