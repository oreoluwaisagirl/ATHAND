...
const AboutATHAND = () => {
  ...
  const features = [
    { icon: '🏠', title: 'Home Services', description: 'Find reliable help for your home' },
    { icon: '✓', title: 'Verified Providers', description: 'All providers are vetted' },
    { icon: '💬', title: 'Easy Communication', description: 'Chat directly with providers' },
    { icon: '⭐', title: 'Reviews & Ratings', description: 'Make informed decisions' },
  ];
  ...
  return (
    <div className="min-h-screen bg-background pb-20">
      ...
      <div className="px-4 py-8 text-center">
        <div className="w-20 h-20 bg-amber rounded-2xl flex items-center justify-center mx-auto mb-4">
      ...
      <div className="px-4 py-4 text-center">
        ...
        <div className="flex justify-center space-x-4">
          <button className="w-10 h-10 bg-container rounded-full flex items-center justify-center border border-border">
            📘
          </button>
          <button className="w-10 h-10 bg-container rounded-full flex items-center justify-center border border-border">
            📸
